...
public class MergeSort {
    ...
    public static void merge(int[] vetor, int inicio, int meio, int fim){
        ...
        int[] vetorP1 = new int[meio+1]; // Vetor correspondente a primeira parte do vetor: do inicio até a meio;
        int[] vetorP2 = new int[(fim-cont1)+1]; // Vetor correspondente a segunda parte do vetor: do meio+1 até o fim;
        ...
        for(int i=0; i<tamanho;i++){
            if(!fim1 && !fim2){ // Se nenhum contador tiver passado do seu limite
                ...
                */
                ...
                if(!fim1) { //Se fim1 for false então negar fim1 dará true entrando no if. Logo, entrar nesse if siginifica que
                    //fim1 = false, logo fim2 = true. Sendo assim sobrou elementos no vetorP1.
                    while (cont1 < meio) {
                        vetor[cont1] = vetorP1[cont1];
                        cont1++;
                    }
                }else{ // saiu pois fim1 = true e fim2 = false;
                    while(auxP2<fim - cont2){
                        vetor[auxP2] = vetorP2[auxP2];
                        auxP2++;
                    }
                }
            }
